...
- (UIButton*)btnLogin{
    if (!_btnLogin) {
        _btnLogin = [[UIButton alloc]initWithFrame:CGRectMake(10, 2.5+40+10, DEVICEWIDTH-20, 45)];
...
- (UIButton*)btnRegister{
    if (!_btnRegister) {
        _btnRegister = [[UIButton alloc]initWithFrame:CGRectMake(10, 2.5+40+10+45+10, 100, 15)];
