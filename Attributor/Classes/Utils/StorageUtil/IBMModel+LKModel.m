...
//
//#import "IBMModel.h"
//#import "IBMModel+LKModel.h"
//#import "LKDBHelper.h"
//#import <UIKit/UIKit.h>
//#import "LKDBUtils.h"
//
//static char LKModelBase_Key_RowID;
//@implementation IBMModel(LKModel)
//
...
////{
////    objc_setAssociatedObject(self, &LKModelBase_Key_RowID,[NSNumber numberWithLongLong:rowid], OBJC_ASSOCIATION_RETAIN_NONATOMIC);
////}
//-(int)rowid
//{
...
//    }
//    free(properties);
//    if([self isContainParent] && [self superclass] != [IBMModel class])
//    {
